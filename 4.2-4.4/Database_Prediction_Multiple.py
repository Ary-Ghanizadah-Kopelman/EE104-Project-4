...
#4.3/4.4 Database Prediction Program
#The program was built on top of the 'Option_4_1_Prediction.py' file from the 4.1 alternative CIFAR-10 tutorial

print("""
4.3/4.4 Database Prediction Program
This program was built on top of the 'Option_4_1_Prediction.py' file from the 4.1 alternative CIFAR-10 tutorial
...
#While loop selection for custom image database         
    ...
    time.sleep(3)
    print("\n\n\n--------------------------------------------------------------------------------------------------------------------------\n")
    print("You are viewing the information for selection number:",sel)
    print("You have chosen to sample image:",image_import,"\n\nPlease wait for the image prediction....\n")
...
while(True):
    sel=input("""
This program processes multiple images in our database.
...
array=np.full(shape=20,fill_value=0)

i=0

while (i<num):
    print("---------------------------------------------------------------------\n\nYou are at selection number:",i+1)
